...
export const BRANCHES_DATA: Record<string, BranchData> = {
  london: {
    ...
    city: 'London',
    region: 'UK',
    heroImage: 'https://imgs.search.brave.com/7NxZNib3aQq96c1evr_tYNqAoUIHPiyFL2gBfUThPXM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9raGFy/aXMub3JnL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDIyLzA4L2No/dXJjaC5qcGc',
    ...
    mapImage: 'https://images.unsplash.com/photo-1505761671935-60b3a7427bad?auto=format&fit=crop&w=1200&q=80',
    mapCoordinates: { lat: 51.5175, lng: -0.1062 },
    leadPastor: {
      name: 'Pastor David Antwi',
      title: 'Lead Pastors — London Branch',
      image: 'https://imgs.search.brave.com/FjszIkKqXCz6HkVlqWGwMiEHMwqoiMMYT9r_oNFrJyo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9odW1h/bnRpYy11c2Vycy1w/cm9maWxlLXBpY3R1/cmUuczMuYW1hem9u/YXdzLmNvbS9saW5r/ZWRpbl9hYmExZTYy/Mjk2MGQzNzFkZWEw/Ni5wbmc',
      quote: 'London is a global crossroads. We exist to build a home of faith, hope, and love for every soul.',
    },
    serviceTimes: [
      { name: 'Morning Celebration', time: '10:00', ampm: 'AM', description: 'Vibrant praise and apostolic doctrine.', kidsMinistry: true },
      { name: 'Afternoon Empowerment', time: '1:00', ampm: 'PM', description: 'Focused service tailored for young professionals.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  birmingham: {
    ...
    city: 'Birmingham',
    region: 'UK',
    heroImage: 'https://imgs.search.brave.com/2AHJTtDNU_RctEz1xWIngoqYX53XYS4gYJ1nHMQTL7k/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9raGFy/aXMub3JnL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDI1LzExL0RT/QzAwNDA3LXNjYWxl/ZC5qcGc',
    ...
    mapImage: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=1200&q=80',
    ...
    serviceTimes: [
      { name: 'Sunday Family Worship', time: '10:30', ampm: 'AM', description: 'Glorious praise and anointed word.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  brighton: {
    ...
    city: 'Brighton',
    region: 'UK',
    heroImage: 'https://images.unsplash.com/photo-1548625361-185859737eb1?auto=format&fit=crop&w=1600&q=80',
    ...
    serviceTimes: [
      { name: 'First Service', time: '9:00', ampm: 'AM', description: 'Dynamic worship & impactful Word.', kidsMinistry: true },
      { name: 'Second Service', time: '11:30', ampm: 'AM', description: 'Full family service.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  bristol: {
    ...
    city: 'Bristol',
    region: 'UK',
    heroImage: 'https://images.unsplash.com/photo-1515586838455-8f8f940d6853?auto=format&fit=crop&w=1600&q=80',
    ...
    serviceTimes: [
      { name: 'Sunday Celebration', time: '10:30', ampm: 'AM', description: 'Praise, Word & fellowship.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  chatham: {
    ...
    city: 'Chatham',
    region: 'UK',
    heroImage: 'https://images.unsplash.com/photo-1519817650390-64a93db51149?auto=format&fit=crop&w=1600&q=80',
    ...
    serviceTimes: [
      { name: 'Sunday Service', time: '10:30', ampm: 'AM', description: 'Worship and interactive word.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  chelmsford: {
    ...
    serviceTimes: [
      { name: 'Sunday Worship', time: '10:00', ampm: 'AM', description: 'Engaging service for all ages.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  coventry: {
    ...
    city: 'Coventry',
    region: 'UK',
    heroImage: 'https://images.unsplash.com/photo-1543832923-44667a44c804?auto=format&fit=crop&w=1600&q=80',
    ...
    serviceTimes: [
      { name: 'Sunday Celebration', time: '10:30', ampm: 'AM', description: 'Worship and Word.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  croydon: {
    ...
    serviceTimes: [
      { name: 'First Service', time: '8:30', ampm: 'AM', description: 'Early morning worship.', kidsMinistry: true },
      { name: 'Main Service', time: '11:00', ampm: 'AM', description: 'Contemporary praise.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  northampton: {
    ...
    serviceTimes: [
      { name: 'Sunday Service', time: '10:00', ampm: 'AM', description: 'Family worship.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  nottingham: {
    ...
    serviceTimes: [
      { name: 'Sunday Celebration', time: '10:30', ampm: 'AM', description: 'Contemporary worship.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  orpington: {
    ...
    serviceTimes: [
      { name: 'Sunday Service', time: '10:00', ampm: 'AM', description: 'Worship and kids ministry.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  reading: {
    ...
    serviceTimes: [
      { name: 'Sunday Worship', time: '10:30', ampm: 'AM', description: 'Praise and Word.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  accra: {
    ...
    serviceTimes: [
      { name: 'First Morning Glory', time: '8:00', ampm: 'AM', description: 'High-energy praise and prayer.', kidsMinistry: true },
      { name: 'Second Celebration', time: '10:30', ampm: 'AM', description: 'Prophetic word and fellowship.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
  ...
  freetown: {
    ...
    serviceTimes: [
      { name: 'Sunday Worship Experience', time: '10:00', ampm: 'AM', description: 'Praise, breakthrough prayer, and Word.', isHighlighted: true, kidsMinistry: true },
    ],
    upcomingEvents: [],
