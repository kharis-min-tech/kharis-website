        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-[#2e2942]">
            <div className="flex items-center gap-2.5">
              <div className="p-2.5 rounded-xl bg-[#6B34FA] text-white shadow-md shadow-[#6B34FA]/30">
          ...
          {isSubmitted ? (
            <div className="py-12 text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-[#6B34FA]/20 text-[#a78bfa] mx-auto flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-4">
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-[#a78bfa] mb-1">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-[#1a1826] border border-[#2e2942]">
                <input
                  ...
                  className="w-4 h-4 rounded text-[#6B34FA] focus:ring-[#6B34FA] bg-[#15131f] border-[#2e2942]"
                />
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-2xl bg-[#6B34FA] hover:bg-[#5420D6] text-white font-extrabold text-base shadow-lg shadow-[#6B34FA]/30 transition-all flex items-center justify-center gap-2 mt-2"
              >
              ...
              <div className="text-center text-xs font-semibold text-[#b2aec1] pt-1">
                📍 700 Grace Way, Metropolitan Campus • Free Parking Available
              </div>
            </form>
          )}
        </motion.div>
