        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-[#2e2942]">
            <div className="flex items-center gap-2.5">
              <div className="p-2.5 rounded-xl bg-[#FD7F20] text-white shadow-md shadow-[#FD7F20]/30">
          ...
          {isSubmitted ? (
            <div className="py-12 text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-[#FD7F20]/10 text-[#FD7F20] mx-auto flex items-center justify-center">
              ...
              <p className="text-sm font-semibold text-[#b2aec1] max-w-sm mx-auto">
                Your contribution of <span className="font-bold text-[#FD7F20]">${amount}</span> directly fuels transformation and hope.
              </p>
            </div>
          ) : (
            <form onSubmit={handleCompleteGive} className="space-y-5 pt-5">
              ...
              {/* Fund Category */}
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-[#a78bfa] mb-2">
                  Select Giving Designation
                </label>
                <select
                  value={fund}
                  onChange={(e) => setFund(e.target.value)}
                  className="w-full px-4 py-3 rounded-2xl border border-[#2e2942] bg-[#1a1826] text-sm font-bold text-[#f3f0f8] focus:outline-none focus:ring-2 focus:ring-[#6B34FA]"
                >
                  {funds.map((f) => (
              ...
              <div>
                  ...
                  {presetAmounts.map((amt) => (
                    <button
                      ...
                      className={`py-2.5 rounded-xl font-extrabold text-sm transition-all ${
                        amount === amt
                          ? 'bg-[#FD7F20] text-white shadow-md shadow-[#FD7F20]/25'
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-3 rounded-2xl border border-[#2e2942] bg-[#1a1826] text-sm font-bold text-[#f3f0f8] focus:outline-none focus:ring-2 focus:ring-[#6B34FA]"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-2xl bg-[#FD7F20] hover:bg-[#E06C14] text-white font-extrabold text-base shadow-lg shadow-[#FD7F20]/30 transition-all flex items-center justify-center gap-2"
              >
                <Heart className="w-5 h-5 fill-white" />
